...
export default class IntroSection {
    ...
    setTitles() {
        ...
        this.objects.add({
            ...
            offset: new THREE.Vector3(-3.2, 0, 0),
            rotation: new THREE.Euler(0, 0, 0),
        ...
        this.objects.add({
            ...
            offset: new THREE.Vector3(6.3, 0, 0),
            rotation: new THREE.Euler(0, 0, 0),
            shadow: { sizeX: 1.5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.4 },
            mass: 1.5,
            soundName: 'brick'
        ...
        this.objects.add({
            ...
            offset: new THREE.Vector3(7.5, 0, 0),
            rotation: new THREE.Euler(0, 0, 0),
            shadow: { sizeX: 1.5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.4 },
            mass: 1.5,
            soundName: 'brick'
        ...
        this.objects.add({
            ...
            offset: new THREE.Vector3(8.7, 0, 0),
            rotation: new THREE.Euler(0, 0, 0),
            duplicated: true,
            shadow: { sizeX: 1.5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.4 },
            mass: 1.5,
        ...
        this.objects.add({
            ...
            offset: new THREE.Vector3(11.2, 0, 0),
            rotation: new THREE.Euler(0, 0, 0),
            duplicated: true,
            shadow: { sizeX: 1.5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.4 },
            mass: 1.5,
